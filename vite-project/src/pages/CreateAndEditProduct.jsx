        ...
        <div className="flex flex-col justify-center">
            ...
            <form onSubmit={handleSubmit} class="w-250 max-w-full mx-auto border border-black">
                ...
                <div class="mb-5">
                    ...
                    <input onChange={(e) => { setimageUrl(e.target.value) }} value={imageUrl} type="text" id="imageUrl" class="shadow-xs bg-yellow-100 border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-xs-light" required />
                </div>
